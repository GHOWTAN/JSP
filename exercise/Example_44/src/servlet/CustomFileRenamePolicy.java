...
public class CustomFileRenamePolicy implements FileRenamePolicy {
 ...
 public CustomFileRenamePolicy(String userName) {
 ...
 public File rename(File file) {
  // Here we get the parent directory path as in U:/myservlet/user_data
  ...
  fileName = userName + "_" + fileName + "_" + sdf.format(date);
